...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header font-weight-bold text-white sloginbar">{{ __('Edit Profile') }}</div>

                <div class="card-body">
                    <form method="POST" action="/staff/profile/{{$user -> id}}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            <label for="creditLimit" class="col-md-4 col-form-label text-md-right">{{ __('Credit Limit') }}</label>

                            <div class="col-md-6">
                                <input id="creditLimit" type="text" class="form-control   @error('creditLimit') is-invalid @enderror" name="creditLimit" value="{{ $user->creditLimit ??  old('creditLimit') }}" required autocomplete="creditLimit" >
